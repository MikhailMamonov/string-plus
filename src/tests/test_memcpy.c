...
MEMCPY_TEST_CASES(string_tests, {"Hello", 5, "basic"},
                  {"Hello, world.", 13, "full"},
                  {"World", 6, "with null terminator"}, {"Test", 4, "partial"},
                  {"Hello, world.", 5, "partial_5_bytes"},
                  {"", 1, "null terminator"}, {"A", 1, "single char"},
...
MEMCPY_TEST_CASES(edge_tests, {"", 0, "zero size"},
