...
STRNCAT_TEST_CASES(strncat_basic,
                   {"Hello, ",  "World!",   6,  "basic_full"},
                   {"foo",      "bar",      3,  "foo_bar"},
                   {"abc",      "def",      3,  "abc_def"},
                   {"School",   "21",       2,  "school_21"}
)

STRNCAT_TEST_CASES(strncat_partial,
                   {"Hello, ",  "World!",   3,  "only_first_3"},
...
STRNCAT_TEST_CASES(strncat_n_zero,
                   {"Hello",    "World",    0,   "n_zero_normal"},
                   {"",         "abc",      0,   "n_zero_empty_dest"},
                   {"abc",      "",         0,   "n_zero_empty_src"}
)

STRNCAT_TEST_CASES(strncat_empty_strings,
                   {"",         "World",    5,   "empty_dest"},
                   {"Hello",    "",         5,   "empty_src"},
                   {"",         "",         5,   "both_empty"},
...
STRNCAT_TEST_CASES(strncat_special_chars,
                   {"line1\n",  "line2\n",  6,   "newlines"},
                   {"tab\t",    "end",      3,   "tab_char"},
...
STRNCAT_TEST_CASES(strncat_long_strings,
                   {"The quick brown fox ",
                       "jumps over the lazy dog", 23, "long_full"},
                   {"The quick brown fox ",
                       "jumps over the lazy dog", 5,  "long_partial"},
                   {"aaaaaaaaaa",
                       "bbbbbbbbbb",              10, "ten_a_ten_b"}
)
