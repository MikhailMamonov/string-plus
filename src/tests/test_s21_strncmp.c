...
void run_strncmp_test(strncmpParams *params) {
  ck_assert_int_eq(sign(s21_strncmp(params->str1, params->str2, params->n)),
                   sign(strncmp(params->str1, params->str2, params->n)));
}

STRNCMP_TEST_CASES(string_tests, {"hello", "hello", 5}, {"hello", "hell", 4},
                   {"apple", "apricot", 2}, {"apple", "banana", 0},
                   {"cat", "cat", 10}, {"Hello", "hello", 5},
                   {"hello", "Hello", 5}, {"apple", "applepie", 8},
                   {"applepie", "apple", 8}, {"abc", "xyz", 3})

STRNCMP_TEST_CASES(edge_tests, {"", "", 5}, {"", "abc", 3}, {"abc", "", 3},
                   {"", "hello", 0}, {"\x80", "\x10", 1},
                   {"hell\0no", "hell", 6});
