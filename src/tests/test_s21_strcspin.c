...
void run_strcspin_test(StrCspinTestParams *params) {
    ...
    s21_strcspin(dest_test, params->src, params->size);
    strcspin(dest_std, params->src, params->size);
...
STRCSPIN_TEST_CASES(string_tests,
    {"Hello",5 ,  "basic"},
    {"Hello, world.",13, "full"},
...
Suite *strcspin_suite_create(void) {
    Suite *s = suite_create("strcspin");
