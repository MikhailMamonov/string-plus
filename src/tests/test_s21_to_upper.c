...
TO_UPPER_TEST_CASES(to_upper_basic, {"hello", "HELLO", "all lowercase"},
...
// Граничные случаи
TO_UPPER_TEST_CASES(to_upper_edge, {"", "", "empty string"},
...
// Пробельные символы
TO_UPPER_TEST_CASES(to_upper_whitespace,
                    {"  hello\tworld\n", "  HELLO\tWORLD\n",
                     "spaces, tab, newline"},
                    {"     ", "     ", "only spaces"},
...
TO_UPPER_TEST_CASES(to_upper_null,
