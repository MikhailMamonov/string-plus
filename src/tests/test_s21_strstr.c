...
STRSTR_TEST_CASES(strstr_empty_haystack,
                  {"", "a",    "empty_haystack_one_char"},
                  {"", "abc",  "empty_haystack_word"}
)

STRSTR_TEST_CASES(strstr_full_match,
                  {"abc",   "abc",   "exact_match_short"},
...
STRSTR_TEST_CASES(strstr_special_chars,
                  {"line1\nline2",   "\n",      "find_newline"},
                  {"tab\there",      "\t",      "find_tab"},
...
STRSTR_TEST_CASES(strstr_long_strings,
